...
def run_complex_examples(override_maze_approach=None):
    ...
    for i in range(num_problems):
        ...
        print(
            f"Starting maze generation for problem {i+1} using approach {maze_generation_approach}..."
        )
    ...
    print("Animation saved as 'pathfinding_visualization.mp4'")
    ...
    if use_save_as_gif:
        ...
        print("Animation saved as 'pathfinding_visualization.gif'")
    plt.close(fig)
